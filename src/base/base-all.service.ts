...
export class BaseService {
	...
	protected clientId = environment.clientId;
	...
	getJSON(dataUrl: string, options?: RequestOptions): Promise<Object> {
		//debugger;
	...
	formatUrl(ajaxUrl: string): string {
		let url = ajaxUrl;
		if (!this.isTest && !ajaxUrl.startsWith("http://") && !ajaxUrl.startsWith("/remote/api/")) {
